  ...
  const plants = [
    {
      ...
      description: (
        <>
          ...
          <strong>Distancias:</strong> Santa Apolonia – Chetilla, altura del Km16, desvío hacia San Cristóbal, 05 Kms. Total, distancia Santa Apolonia – Hornos es de 21 Kms.<br />
    ...
    },
    {
      ...
      description: (
        <>
          ...
          <strong>Distancias:</strong> Kilómetro nueve (09) de la carretera Baños del Inca-Celendín.<br />
